...
//
//     FoldingRangeOptionsClass.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class FoldingRangeOptionsClass {
        public:
        FoldingRangeOptionsClass() = default;
        virtual ~FoldingRangeOptionsClass() = default;
