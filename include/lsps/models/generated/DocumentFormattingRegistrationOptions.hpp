...
//
//     DocumentFormattingRegistrationOptions.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class DocumentFormattingRegistrationOptions {
        public:
        DocumentFormattingRegistrationOptions() = default;
        virtual ~DocumentFormattingRegistrationOptions() = default;
