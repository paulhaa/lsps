...
//
//     SelectionRangeParams.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class SelectionRangeParams {
        ...
        virtual ~SelectionRangeParams() = default;
        ...
        std::vector<Position> & get_mutable_positions() { return positions; }
        void set_positions(const std::vector<Position> & value) { this->positions = value; }
