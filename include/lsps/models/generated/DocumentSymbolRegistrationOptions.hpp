...
//
//     DocumentSymbolRegistrationOptions.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class DocumentSymbolRegistrationOptions {
        public:
        DocumentSymbolRegistrationOptions() = default;
        virtual ~DocumentSymbolRegistrationOptions() = default;
