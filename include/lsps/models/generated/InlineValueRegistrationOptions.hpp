...
//
//     InlineValueRegistrationOptions.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class InlineValueRegistrationOptions {
        public:
        InlineValueRegistrationOptions() = default;
        virtual ~InlineValueRegistrationOptions() = default;
