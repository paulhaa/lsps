...
//
//     SemanticTokensOptions.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class SemanticTokensOptions {
        ...
        virtual ~SemanticTokensOptions() = default;

        private:
        std::optional<FullUnion> full;
        SemanticTokensLegend legend;
        std::optional<RangeUnion> range;
         ...
         */
        std::optional<FullUnion> get_full() const { return full; }
        void set_full(std::optional<FullUnion> value) { this->full = value; }
         ...
         */
        std::optional<RangeUnion> get_range() const { return range; }
        void set_range(std::optional<RangeUnion> value) { this->range = value; }
