...
//
//     CallHierarchyOptionsClass.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class CallHierarchyOptionsClass {
        public:
        CallHierarchyOptionsClass() = default;
        virtual ~CallHierarchyOptionsClass() = default;
