...
//
//     DocumentRangeFormattingRegistrationOptions.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class DocumentRangeFormattingRegistrationOptions {
        public:
        DocumentRangeFormattingRegistrationOptions() = default;
        virtual ~DocumentRangeFormattingRegistrationOptions() = default;
