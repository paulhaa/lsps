...
//
//     DocumentSymbolClientCapabilitiesSymbolKind.hpp data = nlohmann::json::parse(jsonString);
...
namespace lsps {
    ...
    class DocumentSymbolClientCapabilitiesSymbolKind {
        public:
        DocumentSymbolClientCapabilitiesSymbolKind() = default;
        virtual ~DocumentSymbolClientCapabilitiesSymbolKind() = default;
