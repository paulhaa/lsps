...
//
//     EditRangeClass.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class EditRangeClass {
        public:
        EditRangeClass() = default;
        virtual ~EditRangeClass() = default;
         ...
         */
        std::optional<Position> get_end() const { return end; }
        void set_end(std::optional<Position> value) { this->end = value; }

        /**
         * The range's start position.
         */
        std::optional<Position> get_start() const { return start; }
        void set_start(std::optional<Position> value) { this->start = value; }
