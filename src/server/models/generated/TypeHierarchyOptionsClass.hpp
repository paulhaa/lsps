...
//
//     TypeHierarchyOptionsClass.hpp data = nlohmann::json::parse(jsonString);
...
namespace lsps {
    ...
    class TypeHierarchyOptionsClass {
        public:
        TypeHierarchyOptionsClass() = default;
        virtual ~TypeHierarchyOptionsClass() = default;
