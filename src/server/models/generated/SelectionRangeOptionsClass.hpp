...
//
//     SelectionRangeOptionsClass.hpp data = nlohmann::json::parse(jsonString);
...
namespace lsps {
    ...
    class SelectionRangeOptionsClass {
        public:
        SelectionRangeOptionsClass() = default;
        virtual ~SelectionRangeOptionsClass() = default;
