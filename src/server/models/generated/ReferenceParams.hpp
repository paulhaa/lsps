...
//
//     ReferenceParams.hpp data = nlohmann::json::parse(jsonString);
...
namespace models {
    ...
    class ReferenceParams {
        ...
        public:
        const ReferenceContext & get_context() const { return context; }
        ReferenceContext & get_mutable_context() { return context; }
        void set_context(const ReferenceContext & value) { this->context = value; }
