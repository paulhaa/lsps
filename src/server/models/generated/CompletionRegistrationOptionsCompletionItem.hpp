...
//
//     CompletionRegistrationOptionsCompletionItem.hpp data = nlohmann::json::parse(jsonString);
...
namespace lsps {
    ...
    class CompletionRegistrationOptionsCompletionItem {
        public:
        CompletionRegistrationOptionsCompletionItem() = default;
        virtual ~CompletionRegistrationOptionsCompletionItem() = default;
