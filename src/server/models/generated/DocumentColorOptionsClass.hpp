...
//
//     DocumentColorOptionsClass.hpp data = nlohmann::json::parse(jsonString);
...
namespace lsps {
    ...
    class DocumentColorOptionsClass {
        public:
        DocumentColorOptionsClass() = default;
        virtual ~DocumentColorOptionsClass() = default;
